<template>
  ...
  >
    ...
    >
      <div>
        <div
          class="input-group input-group-alternative bg-white px-4 py-2 d-flex align-items-center"
      ...
      <div class="d-flex align-items-center">
        <div style="height: 50px; width: 50px" class="bg-white rounded-circle">
          <img
            class="embed-responsive h-100"
            src="~assets/img/wooman-think.svg"
          >
        </div>
        <b-dropdown
          id="dropdown-1"
        ...
        >
          <template slot="button-content">
            <div class="text-light font-weight-bold">
              <span class="text-lg">{{ this.$auth.user.first_name }}
          ...
          <b-dropdown-item @click="handleDisconnect">
            <span class="text-danger">Deconnexion</span>
          </b-dropdown-item>
        </b-dropdown>
      </div>
    </div>
